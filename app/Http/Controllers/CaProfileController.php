...
class CaProfileController extends Controller
{
	...
	protected function validator_attachment(array $data)
    {
		...
		if($data['gst_doc'] !='undefined')
		{
			$gst_doc = 'image|mimes:jpeg,png,jpg,pdf,PDF|max:51200';
		}
		else{
			$gst_doc = '';
		}
		if($data['pan_doc'] !='undefined')
		{
			$pan_doc = 'image|mimes:jpeg,png,jpg,pdf,PDF|max:51200';
		}
		else{
			$pan_doc = '';
		}
		if($data['tan_doc'] !='undefined')
		{
			$tan_doc = 'image|mimes:jpeg,png,jpg,pdf,PDF|max:51200';
		}else{
			$tan_doc = '';
		}
		if($data['cin_doc'] !='undefined')
		{
			$cin_doc = 'image|mimes:jpeg,png,jpg,pdf,PDF|max:51200';
		}else{
			$cin_doc = '';
		}
		if($data['other_logo_doc'] !='undefined')
		{
			$other_logo_doc = 'image|mimes:jpeg,png,jpg,pdf,PDF|max:51200';
		}else{
			$other_logo_doc = '';
		}
		if($data['signature_doc'] !='undefined')
		{
			$signature_doc = 'image|mimes:jpeg,png,jpg,pdf,PDF|max:51200';
		}else{
			$signature_doc = '';
		}
		if($data['stamp_doc'] !='undefined')
		{
			$stamp_doc = 'image|mimes:jpeg,png,jpg,pdf,PDF|max:51200';
		}else{
			$stamp_doc = '';
		}
		if($data['gstdocstate'] ==''){
