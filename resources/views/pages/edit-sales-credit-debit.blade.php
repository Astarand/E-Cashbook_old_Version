        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="content-page-header">
                    <h5>Edit Sales Credit Debit Note</h5>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-lg-6">
                    ...
                    <input type="text" name="inv_num" id="inv_num" value="{{ $sales->invoice_number }}" class="form-control" disabled required="">
                </div>
                {{-- <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="form-group ">
                                            ...
                                            <input type="date" name="date_of_payment" value="{{ $sales->date_of_payment }}" id="date_of_payment" class="form-control" placeholder="Date of Paymemt">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select name="mode_of_pay" id="mode_of_pay" class="form-select has-success">
                                                    <option value="">Select</option>
                                                    <option value="IMPS" {{ $sales->mode_of_pay == 'IMPS' ? 'selected' : '' }}>IMPS</option>
                                                    <option value="RTGS" {{ $sales->mode_of_pay == 'RTGS' ? 'selected' : '' }}>RTGS</option>
                                                    <option value="NEFT" {{ $sales->mode_of_pay == 'NEFT' ? 'selected' : '' }}>NEFT</option>
                                                    <option value="UPI" {{ $sales->mode_of_pay == 'UPI' ? 'selected' : '' }}>UPI</option>
                                                    <option value="CARD" {{ $sales->mode_of_pay == 'CARD' ? 'selected' : '' }}>Credit/Debit Card</option>
                                                    <option value="CASH" {{ $sales->mode_of_pay == 'CASH' ? 'selected' : '' }}>Cash</option>
                                                    <option value="OTHER" {{ $sales->mode_of_pay == 'OTHER' ? 'selected' : '' }}>Other</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select class="form-select has-success" name="pay_status" id="pay_status" >
                                                    <option value="" >Select</option>
                                                    <option {{ $sales->pay_status == 'Full' ? 'selected' : '' }} value="Full">Full Payment</option>
                                                    <option {{ $sales->pay_status == 'Partial' ? 'selected' : '' }} value="Partial">Partial Payment</option>
                                                    <option {{ $sales->pay_status == 'Due' ? 'selected' : '' }} value="Due">Due</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
