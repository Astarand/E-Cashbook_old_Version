                ...
                <div class="content-page-header">
                    ...
                    <div class="list-btn">
                        <ul class="filter-list">
                            ...
                            <li>
                                <a class="btn btn-primary" href="addasset"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add New Asset</a>
                            </li>
							@endif
                        </ul>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center table-hover datatable">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $asset->purchase_by }}</td>
                                    <td class="d-flex align-items-center">
                                        <a href="{{ url('/view-asset/'.base64_encode($asset->id)) }}" class="btn btn-greys me-2"><i class="fa fa-eye me-1"></i> Show Details</a>
                                        <div class="dropdown dropdown-action">
                                            <a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                            <ul>
                                                <li>
                                                    <a class="dropdown-item" href="{{ url('/view-asset/'.base64_encode($asset->id)) }}"><i class="far fa-edit me-2"></i>View</a>
                                                </li>
												@if ( (Auth::user()->u_type == 2 || Auth::user()->u_type == 3))
												<li>
                                                    <a class="dropdown-item" href="{{ url('/edit-asset/'.base64_encode($asset->id)) }}"><i class="far fa-edit me-2"></i>Edit</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item assetdelete" href="javascript:void(0);" data-id="{{$asset->id}}" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                                </li>
												@endif
                                            </ul>
                                            </div>
							...
							<div class="d-flex justify-content-center">
								<?php echo $assets_pagination->links() ?>
							</div>
                        </div>
                    </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <button type="reset" data-bs-dismiss="modal" id="del_asset" class="w-100 btn btn-primary paid-continue-btn">Delete</button>
                        </div>
                        <div class="col-6">
