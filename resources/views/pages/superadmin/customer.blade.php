                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ url('/customerprofile/'.base64_encode($user->id)) }}" class="avatar avatar-md me-2"><img class="avatar-img rounded-circle" src="{{asset('/public/uploads/profile/'.$user->comp_logo)}}" alt=""></a>
                                                <a href="{{ url('/customerprofile/'.base64_encode($user->id)) }}">{{ $user->comp_name }} <span><span>{{ $user->comp_email }}</span></span></a>
                                            </h2>
                                        </td>
