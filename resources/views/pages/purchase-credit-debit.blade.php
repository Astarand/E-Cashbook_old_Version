        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="content-page-header">
                    <h5>Purchase Credit Dabit Notes</h5>
                    <div class="list-btn">
                        <ul class="filter-list">
                            ...
                            <li>
                                <a class="btn btn-primary" href="add-purchase-credit-debit"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Create New Notes</a>
                            </li>
							@endif
                        </ul>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>{{ $sale->inv_number }}</strong></td>
                                        ...
                                        <td><i class="fa-solid fa-indian-rupee-sign"></i>&nbsp; {{ $sale->adjusted_amount }}</td>     
                                        <td>
											@if ($sale->is_paid == 1)
                                        ...
                                        <td class="d-flex align-items-center">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul>
                                                        <li>
                                                            <a class="dropdown-item" href="{{ url('/view-purchase-credit-debit/'.base64_encode($sale->id)) }}"><i class="far fa-eye me-2"></i>View</a>
                                                        </li>
														
														@if ( (Auth::user()->u_type == 2 || Auth::user()->u_type == 3))
														<li>
                                                            <a class="dropdown-item" href="{{ url('/edit-purchase-credit-debit/'.base64_encode($sale->id)) }}"><i class="far fa-edit me-2"></i>Edit</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item purchaseCreditDebitdelete" data-id="{{$sale->id}}" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                                        </li>
														
														@if ($sale->is_paid==0)
														<li>
															<a data-id="{{$sale->id}}" data-stat="1" class="dropdown-item pur_paid_creditDebit" href="javascript:void(0);"><i class="fa-solid fa-power-off me-2"></i>Paid</a>
														</li>
														@else
														<li>
															<a data-id="{{$sale->id}}" data-stat="0" class="dropdown-item pur_paid_creditDebit" href="javascript:void(0);"><i class="far fa-bell-slash me-2"></i>Unpaid</a>
														</li>
														@endif
														@if ($sale->status==0)
														<li>
															<a data-id="{{$sale->id}}" data-stat="1" class="dropdown-item pur_active_creditDebit" href="javascript:void(0);"><i class="fa-solid fa-power-off me-2"></i>Activate</a>
														</li>
														@else
														<li>
															<a data-id="{{$sale->id}}" data-stat="0" class="dropdown-item pur_active_creditDebit" href="javascript:void(0);"><i class="far fa-bell-slash me-2"></i>Deactivate</a>
														</li>
														@endif
														@endif
                                                    </ul>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <button type="reset" id="del_purchase_creditdebit" data-bs-dismiss="modal" class="w-100 btn btn-primary paid-continue-btn">Delete</button>
                            </div>
                            <div class="col-6">
