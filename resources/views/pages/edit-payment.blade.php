        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                ...
                <form action="javascript:void(0);" method="post" name="payment_detail" id="payment_detail">
						<input type="hidden" name="payId" id="payId" value="{{$payment->id}}">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="mode_of_payment" id="mode_of_payment">
                                            ...
                                            <option value="NEFT" <?php echo ($payment->mode_of_payment=='NEFT')? "selected":"" ?>>NEFT</option>
                                            <option value="IMPS" <?php echo ($payment->mode_of_payment=='IMPS')? "selected":"" ?>>IMPS</option>
                                            <option value="RTGS" <?php echo ($payment->mode_of_payment=='RTGS')? "selected":"" ?>>RTGS</option>
                                            <option value="Cheque" <?php echo ($payment->mode_of_payment=='Cheque')? "selected":"" ?>>Cheque</option>
                                            <option value="Demand Draft" <?php echo ($payment->mode_of_payment=='Demand Draft')? "selected":"" ?>>Demand Draft</option>
                                            <option value="Pay Order" <?php echo ($payment->mode_of_payment=='Pay Order')? "selected":"" ?>>Pay Order</option>
                                            <option value="UPI" <?php echo ($payment->mode_of_payment=='UPI')? "selected":"" ?>>UPI</option>
                                            <option value="Cash" <?php echo ($payment->mode_of_payment=='Cash')? "selected":"" ?>>Cash</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
