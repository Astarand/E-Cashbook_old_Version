                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="voucher_no" id="voucher_no" placeholder="Enter Voucher Number">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Voucher Name <span class="text-danger"> *</span></label>
                                <input type="text" required class="form-control" name="voucher_name" id="voucher_name" placeholder="Enter Voucher Name">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Invoice Voucher Number <span class="text-danger"> *</span></label>
                                <input type="text" required name="inv_voucher_no" id="inv_voucher_no" class="form-control" placeholder="Enter Opening Stocks">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Total Cost (INR) <span class="text-danger"> *</span></label>
                                <input type="text" required name="total_cost" id="total_cost" class="form-control" placeholder="0">
                            </div>
                        </div>
                    </div>
                </div>
