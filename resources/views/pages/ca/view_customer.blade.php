                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="comp_gst_no" id="comp_gst_no" value="{{$client->gst_no}}" class="form-control" placeholder="Enter Phone Number">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select class="select form-select" name="agent_name" id="agent_name">
                                                    ...
                                                    @foreach($agents as $k=>$val)
															<option value="{{ $val->id }}" <?php echo ($client->agent_name==$val->id)? "selected":"" ?>>{{ $val->agent_name }}</option>
														@endforeach
                                                </select>
                                            </div>
                                        </div>
