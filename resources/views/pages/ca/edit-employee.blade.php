                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" readonly name="email" id="email" value="{{ $employee->email }}" readonly class="form-control readonly" placeholder="Enter Employee Email">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" name="password" readonly id="password" value="{{ $employee->password }}"  class="form-control readonly" placeholder="Create Login Password">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" name="conf_password" value="{{ $employee->password }}" readonly id="passwordInput" class="form-control readonly" placeholder="Create Login Password">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="salary">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label>Providant Fund<span class="text-danger"></span></label>
                                                ...
                                                <?php 
													$permissions = isset($employee->emp_permission)?$employee->emp_permission:"";
