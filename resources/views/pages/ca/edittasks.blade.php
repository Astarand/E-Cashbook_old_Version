                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="task_date" id="task_date" value="{{$task->task_date}}" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <label>Task Time</label>
                                            <input type="text" name="task_time" id="task_time" value="{{$task->task_time}}" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            <select class="select form-select" name="agent_id" id="agent_id">
                                                    ...
                                                    @foreach($agents as $k => $val)
                                                        <option value="{{ $val->id }}" {{ ($task->agent_id == $val->id) ? "selected" : "" }}>
                                                            {{ $val->agent_name }}
                                                        </option>
                                                    @endforeach
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="gov_fees" id="gov_fees" value="{{$task->gov_fees}}" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <label>Services Charges</label>
                                            <input type="text" name="services_charges" id="services_charges" value="{{$task->services_charges}}" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <label>Total Amount</label>
                                            <input type="text" name="total_amount" id="total_amount" value="{{$task->total_amount}}" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
