                ...
                <div class="content-page-header">
                    ...
                    <div class="list-btn">
                        <ul class="filter-list">
                            ...
                            <li>
                                <a class="btn btn-primary" href="{{ url('/addagent') }}"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add New Agent</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a></a>
                                                <a href="{{ url('/agent-view/'.base64_encode($agent->id)) }}">{{ $agent->agent_name }} <span><span class="__cf_email__" data-cfemail="a9c3c6c1c7e9ccd1c8c4d9c5cc87cac6c4">[{{ $agent->agent_email }}]</span></span></a>
                                            </h2>
                                        </td>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('/edit-agent/'.base64_encode($agent->id)) }}"><i class="far fa-edit me-2"></i>Edit</a>
                                                    </li>
                                                    <li>
                                                        <a data-id="{{$agent->id}}" class="dropdown-item agentdelete" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('/agent-view/'.base64_encode($agent->id)) }}"><i class="far fa-eye me-2"></i>View</a>
                                                    </li>
                                                    @if ($agent->status==0)
													<li>
														<a data-id="{{$agent->id}}" data-stat="1" class="dropdown-item agent_active" href="javascript:void(0);"><i class="fa-solid fa-power-off me-2"></i>Activate</a>
													</li>
													@else
													<li>
														<a data-id="{{$agent->id}}" data-stat="0" class="dropdown-item agent_active" href="javascript:void(0);"><i class="far fa-bell-slash me-2"></i>Deactivate</a>
													</li>
													@endif
                                                </ul>
                                                </div>
							...
							<div class="d-flex justify-content-center">
								<?php echo $agents_pagination->links() ?>
							</div>
                        </div>
                    </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <button type="reset" id="del_agent" data-id="" data-bs-dismiss="modal" class="w-100 btn btn-primary paid-continue-btn">Delete</button>
                        </div>
                        <div class="col-6">
