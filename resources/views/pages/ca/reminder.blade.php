                            ...
                            <div class="row align-items-center-center">
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="reminder_type" id="reminder_type" class="form-select"
                                            ...
                                            {{-- <select name="reminder_type" id="reminder_type" onChange="getUserReminder(this);"
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        {{-- <select name="user_type" id="user_type" onChange="getUserOptions(this);" class="form-select "
                                            aria-label="Default select example"> --}}
                                            <select name="user_type" id="user_type" onChange="getUserAccess(this);" class="form-select "
                                                aria-label="Default select example">
                                                <option value=""> Select </option>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="customer_type" id="customer_type" onChange="getUserAccessByStatus(this);"
                                            class="form-select " aria-label="Default select example">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="reminder_through" id="reminder_through" class="form-select "
                                            aria-label="Default select example">
                                            <option value=""> Select </option>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="card">
                                        <div class="card-body card-buttons">
                                            ...
                                            <select name="userId[]" id="userId" class="form-control form-small select tagging"
                                                multiple="multiple">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-6 col-12">
                                    <div class="form-group notes-form-group-info">
                                        <textarea name="msg_text" id="msg_text" class="form-control" placeholder="Enter Message"
