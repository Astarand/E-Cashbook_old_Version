                ...
                <div class="content-page-header">
                    ...
                    <div class="list-btn">
                        <ul class="filter-list">
                            ...
                            <li>
                                <a class="btn btn-primary" href="add-sales-invoice"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Create Invoice</a>
                            </li>
							@endif
                        </ul>
                    </div>
                                ...
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <a href="{{ url('/sales-invoice-pdf/'.base64_encode($sale->id).'/invoice') }}" class="btn btn-greys me-2"><i class="fa fa-eye me-1"></i> View Invoice</a>
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="{{ url('/view-sales-invoice/'.base64_encode($sale->id)) }}"><i class="far fa-eye me-2"></i>View</a>
                                                        </li>
														
														@if ( (Auth::user()->u_type == 2 || Auth::user()->u_type == 3))
														<li>
                                                            <a class="dropdown-item" href="{{ url('/edit-sales-invoice/'.base64_encode($sale->id)) }}"><i class="far fa-edit me-2"></i>Edit</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item invoicedelete" data-id="{{$sale->id}}" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                                        </li>														
														@if ($sale->status==0)
														<li>
															<a data-id="{{$sale->id}}" data-stat="1" class="dropdown-item inv_active" href="javascript:void(0);"><i class="fa-solid fa-power-off me-2"></i>Activate</a>
														</li>
														@else
														<li>
															<a data-id="{{$sale->id}}" data-stat="0" class="dropdown-item inv_active" href="javascript:void(0);"><i class="far fa-bell-slash me-2"></i>Deactivate</a>
														</li>
														@endif
														@endif
                                                    </ul>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <button type="reset" id="del_invoice" data-bs-dismiss="modal" class="w-100 btn btn-primary paid-continue-btn">Delete</button>
                            </div>
                            <div class="col-6">
